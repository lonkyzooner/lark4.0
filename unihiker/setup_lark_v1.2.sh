#!/bin/bash
# LARK v1.2 Setup Script
# Sets up LARK v1.2 directly on the UniHiker
...
# Make lark.py executable
echo -e "${YELLOW}Making LARK executable...${NC}"
chmod +x /root/lark/lark.py
echo -e "${GREEN}LARK is now executable.${NC}"

echo -e "${GREEN}"
echo "====================================="
echo "  LARK v1.2 Setup Complete!"
echo "====================================="
echo -e "${NC}"
