#!/bin/bash
# LARK v1.4 Deployment Script
# Web-style UI version for UniHiker M10
...
scp /Users/bscott/Downloads/L.A.R.K/unihiker/lark_v1.4.py $UNIHIKER_USER@$UNIHIKER_IP:$LARK_DIR/lark.py
...
echo "LARK v1.4 has been deployed to your UniHiker."
