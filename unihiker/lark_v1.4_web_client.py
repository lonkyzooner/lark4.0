...
def draw_ui():
    ...
    # Draw border - using outline color instead of fill=False
    gui.draw_rect(x=0, y=0, w=240, h=240, color=WHITE, outline=CIRCLE_BLUE)
    ...
    if current_state == STATE_READY:
        ...
        gui.draw_circle(x=120, y=120, r=80 + int(pulse_size), color=circle_color)
        gui.draw_circle(x=120, y=120, r=78 + int(pulse_size), color=DARK_BLUE)
