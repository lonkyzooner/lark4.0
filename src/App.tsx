...
import { FluidDesignDemo } from './components/FluidDesignDemo';
    ...
    <LiveKitVoiceProvider>
      <div className="min-h-screen fluid-background text-foreground p-4 md:p-6 overflow-hidden antialiased selection:bg-primary/20 selection:text-primary relative" style={{ background: 'linear-gradient(135deg, #e9f2f9 0%, #d1e6f9 100%)' }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
          <div className="fluid-card rounded-xl p-4 flex items-center justify-center border border-[rgba(255,255,255,0.5)] shadow-md transition-all hover:border-primary/40 backdrop-blur-sm hover:bg-secondary/20" style={{ background: 'rgba(255, 255, 255, 0.85)', backdropFilter: 'blur(12px)' }}>
